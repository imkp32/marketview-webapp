...
const fundURL ="http://34.74.146.25/api/dataservice/mutualfunddata";
...
export class AppProvider extends Component{
  ...
  fetchAnnualStats = async() =>{
    const AnnualURL = "http://34.74.146.25/api/calculationservice?FundId="+this.state.uniqueId+"&StatName=AnnualReturns";
  ...
  fetchMonthlyStats = async() =>{
    const MonthlyURL = "http://34.74.146.25/api/calculationservice?FundId="+this.state.uniqueId+"&StatName=LastThreeMonthsReturns";
    let returnArray=[];
    let monthArray=[];
  ...
  fetchHistStats = async() =>{
    const HistURL = "http://34.74.146.25/api/calculationservice?FundId="+this.state.uniqueId+"&StatName=HistoricalCumulativeReturns";
    let historicalArray = [];
    let dateArray=[];
  ...
  fetchAllStats = async() =>{
      const fullStatsURL = "http://34.74.146.25/api/calculationservice?FundId="+this.state.uniqueId+"&StatName=1 Day Returns,1 Month Returns, 1 Week Returns,1 Quarter Returns, 1 Year Returns, WeekToDate,MonthToDate,YearToDate, QuarterToDate,LastWeekReturns,LastMonthReturns,LastYearReturns,LastQuarterReturns";
